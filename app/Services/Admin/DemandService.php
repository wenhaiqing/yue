...
use Facades\ {
    App\Repositories\Eloquent\DemandRepositoryEloquent,
...
class DemandService {
	...
	protected $module = 'demand';

	protected $indexRoute = 'demand.index';

	protected $createRoute = 'demand.create';

	protected $showRoute = 'demand.show';

	protected $editRoute = 'demand.edit';

	protected $destroyRoute = 'demand.destroy';
...
Eof
			...
			->addColumn(['data' => 'uid', 'name' => 'name', 'title' => trans('demand.uid')])
	        ->addColumn(['data' => 'para_id', 'name' => 'phone', 'title' => trans('demand.para_id')])
	        ->addColumn(['data' => 'cate_id', 'name' => 'email', 'title' => trans('demand.cate_id')])
			->addColumn(['data' => 'yuetime', 'name' => 'yuetime', 'title' => trans('demand.yuetime')])
			->addColumn(['data' => 'validday', 'name' => 'validday', 'title' => trans('demand.validday')])
			->addColumn(['data' => 'needpara', 'name' => 'needpara', 'title' => trans('demand.needpara')])
	        ->addColumn(['data' => 'created_at', 'name' => 'created_at', 'title' => trans('demand.created_at')])
	        ->addColumn(['data' => 'updated_at', 'name' => 'updated_at', 'title' => trans('demand.updated_at')])
	...
	{
		return Datatables::of(DemandRepositoryEloquent::all())
			->addIndexColumn()
	...
	{
		try {
			$demand = DemandRepositoryEloquent::with(['user', 'cate'])->find(decodeId($id, $this->module));
	...
	{
		try {
			$result = DemandRepositoryEloquent::delete(decodeId($id, $this->module));
			cacheClear();
